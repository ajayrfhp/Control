...
class Data:
    ...
    def get_historical_data(self) -> pd.DataFrame:
        ...
        historical_data = pd.pivot_table(
            game_weeks, index='name', columns='GW', values='total_points').reset_index()
    ...
    def build_recent_form_map(self, window_width) -> pd.DataFrame:
        ...
        recent_columns = [historical_data.columns[0]] + \
            list(historical_data.columns[-window_width:])
